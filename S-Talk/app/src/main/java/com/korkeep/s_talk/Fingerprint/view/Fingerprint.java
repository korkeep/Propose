package com.korkeep.s_talk.Fingerprint.view;
...
import com.korkeep.s_talk.Fingerprint.utils.CipherHelper;
import com.korkeep.s_talk.Fingerprint.utils.FingerprintToken;
import com.korkeep.s_talk.Fingerprint.callback.FailAuthCounterCallback;
import com.korkeep.s_talk.Fingerprint.callback.FingerprintCallback;
import com.korkeep.s_talk.Fingerprint.callback.FingerprintSecureCallback;
...
public class Fingerprint extends RelativeLayout {
    ...
    private int dipToPixels() {
        DisplayMetrics metrics = getResources().getDisplayMetrics();
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, Fingerprint.DEFAULT_CIRCLE_SIZE, metrics);
    }
